<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="设备状态" prop="status">
        <el-select v-model="queryParams.status" placeholder="请选择设备状态" clearable>
          <el-option
            v-for="dict in dict.type.sys_uav_status"
            :key="dict.value"
            :label="dict.label"
            :value="dict.value"
          />
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['uav:equipment:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['uav:equipment:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="equipmentList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="续航时长" align="center" prop="flightDuration" />
        ...
        <el-row>
          ...
          <el-col :span="24">
            <el-form-item label="续航时长" prop="flightDuration">
              <el-input v-model="form.flightDuration" placeholder="请输入续航时长" />
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item label="设备状态" prop="status">
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除无人机设备编号为"' + equipmentIds + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('uav/equipment/export', {
        ...this.queryParams
